package com.breezefieldsalesprashant.features.dashboard.presentation
...
import com.breezefieldsalesprashant.*
import com.breezefieldsalesprashant.R
import com.breezefieldsalesprashant.app.*
import com.breezefieldsalesprashant.app.NewFileUtils.browseDocuments
import com.breezefieldsalesprashant.app.NewFileUtils.browsePDFDocuments
import com.breezefieldsalesprashant.app.NewFileUtils.getExtension
import com.breezefieldsalesprashant.app.domain.*
import com.breezefieldsalesprashant.app.types.DashboardType
import com.breezefieldsalesprashant.app.types.FragType
import com.breezefieldsalesprashant.app.types.TopBarConfig
import com.breezefieldsalesprashant.app.uiaction.DisplayAlert
import com.breezefieldsalesprashant.app.utils.*
import com.breezefieldsalesprashant.app.utils.AppUtils.Companion.isProfile
import com.breezefieldsalesprashant.base.BaseResponse
import com.breezefieldsalesprashant.base.presentation.BaseActivity
import com.breezefieldsalesprashant.base.presentation.BaseFragment
import com.breezefieldsalesprashant.features.NewQuotation.*
import com.breezefieldsalesprashant.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldsalesprashant.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldsalesprashant.features.SearchLocation.SearchLocationFragment
import com.breezefieldsalesprashant.features.SearchLocation.locationInfoModel
import com.breezefieldsalesprashant.features.TA.ViewAllTAListFragment
import com.breezefieldsalesprashant.features.achievement.AchievementFragment
import com.breezefieldsalesprashant.features.activities.presentation.*
import com.breezefieldsalesprashant.features.addAttendence.*
import com.breezefieldsalesprashant.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldsalesprashant.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldsalesprashant.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldsalesprashant.features.addAttendence.model.GetReportToResponse
import com.breezefieldsalesprashant.features.addAttendence.model.Leave_list_Response
import com.breezefieldsalesprashant.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldsalesprashant.features.addshop.presentation.AddShopFragment
import com.breezefieldsalesprashant.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldsalesprashant.features.addshop.presentation.ScanImageFragment
import com.breezefieldsalesprashant.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldsalesprashant.features.alarm.model.AlarmData
import com.breezefieldsalesprashant.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldsalesprashant.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldsalesprashant.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldsalesprashant.features.alarm.presetation.VisitReportFragment
import com.breezefieldsalesprashant.features.attendance.AttendanceFragment
import com.breezefieldsalesprashant.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldsalesprashant.features.attendance.model.AttendanceRequest
import com.breezefieldsalesprashant.features.attendance.model.AttendanceResponse
import com.breezefieldsalesprashant.features.averageshop.presentation.AverageShopFragment
import com.breezefieldsalesprashant.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldsalesprashant.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldsalesprashant.features.beatCustom.TeamBeatListFragment
import com.breezefieldsalesprashant.features.billing.presentation.AddBillingFragment
import com.breezefieldsalesprashant.features.billing.presentation.BillingDetailsFragment
import com.breezefieldsalesprashant.features.billing.presentation.BillingListFragment
import com.breezefieldsalesprashant.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldsalesprashant.features.chat.model.ChatListDataModel
import com.breezefieldsalesprashant.features.chat.model.ChatUserDataModel
import com.breezefieldsalesprashant.features.chat.model.GroupUserDataModel
import com.breezefieldsalesprashant.features.chat.presentation.*
import com.breezefieldsalesprashant.features.chatbot.presentation.ChatBotFragment
import com.breezefieldsalesprashant.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldsalesprashant.features.chatbot.presentation.ReportsFragment
import com.breezefieldsalesprashant.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldsalesprashant.features.commondialog.presentation.CommonDialog
import com.breezefieldsalesprashant.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldsalesprashant.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldsalesprashant.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldsalesprashant.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldsalesprashant.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldsalesprashant.features.contacts.ActivityDtlsFrag
import com.breezefieldsalesprashant.features.contacts.AddOpptFrag
import com.breezefieldsalesprashant.features.contacts.ContactDtls
import com.breezefieldsalesprashant.features.contacts.ContactGr
import com.breezefieldsalesprashant.features.contacts.ContactsAddFrag
import com.breezefieldsalesprashant.features.contacts.ContactsFrag
import com.breezefieldsalesprashant.features.contacts.SchedulerAddFormFrag
import com.breezefieldsalesprashant.features.contacts.SchedulerViewFrag
import com.breezefieldsalesprashant.features.contacts.TemplateAddFrag
import com.breezefieldsalesprashant.features.contacts.TemplateViewFrag
import com.breezefieldsalesprashant.features.contacts.ViewCrmOpptFrag
import com.breezefieldsalesprashant.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldsalesprashant.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldsalesprashant.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldsalesprashant.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldsalesprashant.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldsalesprashant.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldsalesprashant.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldsalesprashant.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldsalesprashant.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldsalesprashant.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldsalesprashant.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldsalesprashant.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldsalesprashant.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldsalesprashant.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldsalesprashant.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldsalesprashant.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldsalesprashant.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldsalesprashant.features.document.presentation.DocumentListFragment
import com.breezefieldsalesprashant.features.document.presentation.DocumentTypeListFragment
import com.breezefieldsalesprashant.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldsalesprashant.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldsalesprashant.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldsalesprashant.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldsalesprashant.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldsalesprashant.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldsalesprashant.features.home.presentation.HomeFragment
import com.breezefieldsalesprashant.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldsalesprashant.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldsalesprashant.features.know_your_state.KnowYourStateFragment
import com.breezefieldsalesprashant.features.lead.LeadFrag
import com.breezefieldsalesprashant.features.lead.ViewLeadFrag
import com.breezefieldsalesprashant.features.leaderboard.LeaderBoardFrag
import com.breezefieldsalesprashant.features.leaveapplynew.LeaveHome
import com.breezefieldsalesprashant.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldsalesprashant.features.localshops.LocalShopListFragment
import com.breezefieldsalesprashant.features.localshops.LocalShopListMapFragment
import com.breezefieldsalesprashant.features.localshops.NearByShopsMapFragment
import com.breezefieldsalesprashant.features.location.*
import com.breezefieldsalesprashant.features.location.api.LocationRepoProvider
import com.breezefieldsalesprashant.features.location.model.*
import com.breezefieldsalesprashant.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldsalesprashant.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldsalesprashant.features.login.ShopFeedbackEntity
import com.breezefieldsalesprashant.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldsalesprashant.features.login.presentation.LoginActivity
import com.breezefieldsalesprashant.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldsalesprashant.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldsalesprashant.features.marketAssist.MarketAssistTabFrag
import com.breezefieldsalesprashant.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldsalesprashant.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldsalesprashant.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldsalesprashant.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldsalesprashant.features.member.MapViewForTeamFrag
import com.breezefieldsalesprashant.features.member.model.TeamLocDataModel
import com.breezefieldsalesprashant.features.member.model.TeamShopListDataModel
import com.breezefieldsalesprashant.features.member.presentation.*
import com.breezefieldsalesprashant.features.menuBeat.MenuBeatFrag
import com.breezefieldsalesprashant.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldsalesprashant.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldsalesprashant.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldsalesprashant.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldsalesprashant.features.myjobs.model.CustomerDataModel
import com.breezefieldsalesprashant.features.myjobs.presentation.*
import com.breezefieldsalesprashant.features.mylearning.MyLearningFragment
import com.breezefieldsalesprashant.features.myorder.presentation.MyOrderListFragment
import com.breezefieldsalesprashant.features.myprofile.presentation.MyProfileFragment
import com.breezefieldsalesprashant.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefieldsalesprashant.features.nearbyshops.model.ShopData
import com.breezefieldsalesprashant.features.nearbyshops.model.ShopListResponse
import com.breezefieldsalesprashant.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldsalesprashant.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldsalesprashant.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldsalesprashant.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldsalesprashant.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldsalesprashant.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldsalesprashant.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldsalesprashant.features.newcollection.CollectionShopListFragment
import com.breezefieldsalesprashant.features.newcollection.NewCollectionListFragment
import com.breezefieldsalesprashant.features.newcollectionreport.*
import com.breezefieldsalesprashant.features.notification.NotificationFragment
import com.breezefieldsalesprashant.features.orderITC.CartListFrag
import com.breezefieldsalesprashant.features.orderITC.OrderListFrag
import com.breezefieldsalesprashant.features.orderITC.ProductListFrag
import com.breezefieldsalesprashant.features.orderITC.ViewNewOrdHisAllFrag
import com.breezefieldsalesprashant.features.orderITC.ViewNewOrdHistoryFrag
import com.breezefieldsalesprashant.features.orderITC.ViewOrdDtls
import com.breezefieldsalesprashant.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldsalesprashant.features.orderList.NewOrderListFragment
import com.breezefieldsalesprashant.features.orderList.OrderListFragment
import com.breezefieldsalesprashant.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldsalesprashant.features.orderhistory.ActivityMapFragment
import com.breezefieldsalesprashant.features.orderhistory.OrderhistoryFragment
import com.breezefieldsalesprashant.features.orderhistory.TimeLineFragment
import com.breezefieldsalesprashant.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldsalesprashant.features.orderhistory.model.FetchLocationRequest
import com.breezefieldsalesprashant.features.orderhistory.model.FetchLocationResponse
import com.breezefieldsalesprashant.features.orderhistory.model.LocationData
import com.breezefieldsalesprashant.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldsalesprashant.features.performance.GpsStatusFragment
import com.breezefieldsalesprashant.features.performance.PerformanceFragment
import com.breezefieldsalesprashant.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefieldsalesprashant.features.performance.model.UpdateGpsInputParamsModel
import com.breezefieldsalesprashant.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldsalesprashant.features.performanceAPP.PerformanceAppFragment
import com.breezefieldsalesprashant.features.performanceAPP.allPerformanceFrag
import com.breezefieldsalesprashant.features.permissionList.ViewPermissionFragment
import com.breezefieldsalesprashant.features.photoReg.*
import com.breezefieldsalesprashant.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldsalesprashant.features.quotation.presentation.*
import com.breezefieldsalesprashant.features.reimbursement.presentation.*
import com.breezefieldsalesprashant.features.report.presentation.*
import com.breezefieldsalesprashant.features.returnsOrder.*
import com.breezefieldsalesprashant.features.settings.presentation.SettingsFragment
import com.breezefieldsalesprashant.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldsalesprashant.features.shopdetail.presentation.*
import com.breezefieldsalesprashant.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesprashant.features.stock.StockDetailsFragment
import com.breezefieldsalesprashant.features.stock.StockListFragment
import com.breezefieldsalesprashant.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldsalesprashant.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldsalesprashant.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldsalesprashant.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldsalesprashant.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldsalesprashant.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldsalesprashant.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldsalesprashant.features.survey.SurveyFrag
import com.breezefieldsalesprashant.features.survey.SurveyViewDtlsFrag
import com.breezefieldsalesprashant.features.survey.SurveyViewFrag
import com.breezefieldsalesprashant.features.task.presentation.AddTaskFragment
import com.breezefieldsalesprashant.features.task.presentation.CalenderTaskFragment
import com.breezefieldsalesprashant.features.task.presentation.EditTaskFragment
import com.breezefieldsalesprashant.features.task.presentation.TaskListFragment
import com.breezefieldsalesprashant.features.taskManagement.TaskManagementFrag
import com.breezefieldsalesprashant.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldsalesprashant.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldsalesprashant.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldsalesprashant.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldsalesprashant.features.viewAllOrder.CartFragment
import com.breezefieldsalesprashant.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldsalesprashant.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldsalesprashant.features.viewAllOrder.ViewCartFragment
import com.breezefieldsalesprashant.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldsalesprashant.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldsalesprashant.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldsalesprashant.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldsalesprashant.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldsalesprashant.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldsalesprashant.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldsalesprashant.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldsalesprashant.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldsalesprashant.features.viewPPDDStock.ViewStockFragment
import com.breezefieldsalesprashant.features.weather.presentation.WeatherFragment
import com.breezefieldsalesprashant.mappackage.MapActivity
import com.breezefieldsalesprashant.mappackage.MapActivityWithoutPath
import com.breezefieldsalesprashant.mappackage.SendBrod
import com.breezefieldsalesprashant.widgets.AppCustomEditText
import com.breezefieldsalesprashant.widgets.AppCustomTextView
...
import com.breezefieldsalesprashant.features.login.api.opportunity.OpportunityRepoProvider
import com.breezefieldsalesprashant.features.mylearning.BookmarkFetchResponse
import com.breezefieldsalesprashant.features.mylearning.BookmarkFrag
import com.breezefieldsalesprashant.features.mylearning.BookmarkPlayFrag
import com.breezefieldsalesprashant.features.mylearning.KnowledgeHubAllVideoList
import com.breezefieldsalesprashant.features.mylearning.LeaderboardLmsFrag
import com.breezefieldsalesprashant.features.mylearning.LmsQuestionAnswerSet
import com.breezefieldsalesprashant.features.mylearning.MyLearningAllVideoList
import com.breezefieldsalesprashant.features.mylearning.MyLearningTopicList
import com.breezefieldsalesprashant.features.mylearning.MyLearningVideoPlay
import com.breezefieldsalesprashant.features.mylearning.MyPerformanceFrag
import com.breezefieldsalesprashant.features.mylearning.NotificationLMSFragment
import com.breezefieldsalesprashant.features.mylearning.SearchLmsFrag
import com.breezefieldsalesprashant.features.mylearning.SearchLmsKnowledgeFrag
import com.breezefieldsalesprashant.features.mylearning.SearchLmsLearningFrag
import com.breezefieldsalesprashant.features.mylearning.VideoPlayLMS
import com.breezefieldsalesprashant.features.mylearning.apiCall.LMSRepoProvider
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldsalesprashantlogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesprashantlogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezefieldsalesprashant/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezefieldsalesprashantlogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezefieldsalesprashantlogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezefieldsalesprashantlogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
