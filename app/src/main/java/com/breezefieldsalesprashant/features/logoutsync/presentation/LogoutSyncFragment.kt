package com.breezefieldsalesprashant.features.logoutsync.presentation
...
import com.breezefieldsalesprashant.app.AppDatabase
...
import com.breezefieldsalesprashant.app.utils.Toaster
import com.breezefieldsalesprashant.base.BaseResponse
import com.breezefieldsalesprashant.base.presentation.BaseActivity
import com.breezefieldsalesprashant.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldsalesprashant.features.billing.api.AddBillingRepoProvider
import com.breezefieldsalesprashant.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldsalesprashant.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldsalesprashant.features.document.model.AddEditDocumentInputParams
import com.breezefieldsalesprashant.features.document.model.DocumentAttachmentModel
...
import com.breezefieldsalesprashant.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezefieldsalesprashant.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldsalesprashant.features.orderhistory.model.*
...
import com.breezefieldsalesprashant.features.quotation.model.AddQuotInputModel
import com.breezefieldsalesprashant.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesprashant.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldsalesprashant.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.breezefieldsalesprashant.features.stock.api.StockRepositoryProvider
import com.breezefieldsalesprashant.features.stock.model.AddStockInputParamsModel
import com.breezefieldsalesprashant.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldsalesprashant.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldsalesprashant.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldsalesprashant.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldsalesprashant.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldsalesprashant.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldsalesprashant.mappackage.SendBrod
import com.breezefieldsalesprashant.widgets.AppCustomTextView
import com.breezefieldsalesprashant.MonitorService
import com.breezefieldsalesprashant.MySingleton
import com.breezefieldsalesprashant.app.AlarmReceiver
...
import com.breezefieldsalesprashant.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldsalesprashant.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldsalesprashant.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldsalesprashant.features.orderITC.SyncDeleteOpptL
...
import com.breezefieldsalesprashant.features.orderITC.SyncOpptProductL
import com.breezefieldsalesprashant.features.orderITC.SyncOrd
import com.breezefieldsalesprashant.features.orderITC.SyncOrdProductL
import com.breezefieldsalesprashant.features.performance.model.Gps_status_list
import com.breezefieldsalesprashant.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldsalesprashant.features.returnsOrder.ReturnProductList
import com.breezefieldsalesprashant.features.returnsOrder.ReturnRequest
import com.breezefieldsalesprashant.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesprashantlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesprashantlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesprashantlogsample/log.zip").path);
