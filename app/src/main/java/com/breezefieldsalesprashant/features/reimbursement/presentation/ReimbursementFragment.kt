package com.breezefieldsalesprashant.features.reimbursement.presentation
...
import com.breezefieldsalesprashant.app.utils.AppUtils.Companion.convertFromRightToReverseFormatWithTime
import com.breezefieldsalesprashant.app.utils.AppUtils.Companion.getFormattedDateForApi
import com.breezefieldsalesprashant.app.utils.AppUtils.Companion.hideSoftKeyboard
import com.breezefieldsalesprashant.app.utils.CustomTextWatcher
import com.breezefieldsalesprashant.app.utils.PermissionUtils
import com.breezefieldsalesprashant.app.utils.ProcessImageUtils_v1
...
import com.breezefieldsalesprashant.features.reimbursement.api.ReimbursementConfigRepoProvider
import com.breezefieldsalesprashant.features.reimbursement.api.applyapi.ApplyReimbursementRepoProvider
import com.breezefieldsalesprashant.features.reimbursement.api.configfetchapi.ReimbursementConfigFetchRepoProvider
import com.breezefieldsalesprashant.features.reimbursement.api.reimbursement_list_api.ReimbursementListRepoProvider
import com.breezefieldsalesprashant.features.reimbursement.api.reimbursementshopapi.ReimbursementShopRepoProvider
import com.breezefieldsalesprashant.features.reimbursement.model.*
import com.breezefieldsalesprashant.features.reimbursement.model.reimbursement_shop.ReimbursementShopDataModel
import com.breezefieldsalesprashant.features.reimbursement.model.reimbursement_shop.ReimbursementShopResponseModel
import com.breezefieldsalesprashant.features.reimbursement.model.reimbursementlist.ReimbursementListDataModel
import com.breezefieldsalesprashant.features.reimbursement.model.reimbursementlist.ReimbursementListDetailsModel
import com.breezefieldsalesprashant.features.reimbursement.model.reimbursementlist.ReimbursementListResponseModel
...
class ReimbursementFragment : BaseFragment(), DateAdapter.onPetSelectedListener, View.OnClickListener, TabLayout.OnTabSelectedListener, RadioGroup.OnCheckedChangeListener {
    ...
    private fun initView(view: View) {
        ...
        //attachbreezefieldsalesprashantData()
...
//                            XLog.d("ReimbursementConfigApiResponse ERROR: " + error.localizedMessage)
    ...
    private fun attachbreezefieldsalesprashantData() {
